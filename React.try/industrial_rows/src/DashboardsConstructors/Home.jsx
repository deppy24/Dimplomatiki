...
import 
{ BsFillArchiveFill, BsFillGrid3X3GapFill, BsPeopleFill, BsFillBellFill, BsFillClockFill}
 from 'react-icons/bs'
 import 
  ...
  return (
    <main className='main-container'>
        ...
        <div className="about-section">
            <br/><h1>ΑΝΑΚΟΙΝΩΣΕΙΣ </h1> <br/>
            <div class="flexbox">
                <span class="textbox1">Ανακοίνωση 1</span> <br/><br/>
                <span class="textbox1">Ανακοίνωση 2</span>
            </div>
